...
function assetProtection({adp=999,weight=1}){
...
function waiverValue({currentProjection=0,projectionHistory=[],recentActual=[],adp=999,assetWeight=1,isDrop=false}){
...
function evaluateWaiver({add,drop,minEdge=2.5,assetWeight=1}){
