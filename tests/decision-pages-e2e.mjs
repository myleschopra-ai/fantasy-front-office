...
try{
 ...
 const draft=await browser.newPage({viewport:{width:1884,height:973}});await draft.addInitScript(()=>{let seed=42;Math.random=()=>((seed=Math.imul(seed,1664525)+1013904223>>>0)/4294967296);});await routeCommon(draft);
